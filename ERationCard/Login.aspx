...
<body>
    <form id="form1" runat="server">
        <div class="login">
            <h1><a href="index.html">E Ration Card Login </a></h1>
            <div class="login-bottom">
                ...
                <div class="col-md-6">
                    ...
                    <asp:DropDownList ID="ddlUserType" runat="server" CssClass="ddlselect">
                        <asp:ListItem Value="0">--Select User--</asp:ListItem>
                        <asp:ListItem Value="1">Admin</asp:ListItem>
                        <asp:ListItem Value="2">User</asp:ListItem>
                    </asp:DropDownList>
                    <div class="clearfix"></div>
                    <a class="news-letter " href="ForgotPassword.aspx" style="margin-top:10px;text-align:center;">
                        <label><i></i>Forget Password</label>
                    </a>
