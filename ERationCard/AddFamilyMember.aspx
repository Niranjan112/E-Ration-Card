<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddFamilyMember.aspx.cs" Inherits="AddFamilyMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    ValidationExpression="[a-z,A-Z ]*$" ErrorMessage="*Valid characters: Alphabets and space." />
                                        </div>
                                        <div class="col-md-4 form-group1 form-last">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                ControlToValidate="txtMName" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-4 form-group1 form-last">
                                            <asp:TextBox ID="txtLName" runat="server" placeholder="Last Name *" CssClass="textStyle"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                                                ControlToValidate="txtLName" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="clearfix"></div>
                ...
                <asp:ImageButton ID="imgbtn1" runat="server" Width="20px" Height="20px"
                    ImageUrl="~/images/del.jpg" ImageAlign="Middle"
                    PID='<%#Eval("id")%>' OnClick="DeleteFile"
                    OnClientClick="return confirm('Are you sure to delete this File?');"
                    Visible="False" />
                                            &nbsp; 
                <asp:Label ID="lblfilename" runat="server"></asp:Label>
                                            <asp:Label ID="lblerror" runat="server" Text="Invalid File..!!"
                                    ...
                                    <div>
                                        <div class="col-md-4 form-group1 form-last">
                                            <asp:TextBox ID="txtContact" runat="server" CssClass="textInputStyle" onkeypress="if(event.KeyCode<48||event.keyCode>57)event.returnValue=false;" MaxLength="12" placeholder="Contact *"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                                ControlToValidate="txtContact" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-4 form-group1">
                                            <asp:TextBox ID="TxtEmail" runat="server" CssClass="textInputStyle" placeholder="Email *"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                ControlToValidate="TxtEmail" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtEmail" ErrorMessage="Enter valid Email Id!" ValidationGroup="savedata" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                        </div>
                                        <div class="col-md-4 form-group1">
                                            <asp:TextBox ID="txtAddress" CssClass="textInputStyle" runat="server" placeholder="Address *"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                                                ControlToValidate="txtAddress" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="col-md-4 form-group1">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"
                                                ControlToValidate="txtDistrict" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-4 form-group1">
                                            <asp:TextBox ID="txtTaluka" runat="server" placeholder="Taluka *" CssClass="textInputStyle"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                                ControlToValidate="txtTaluka" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div>
                                        <div class="col-md-4 form-group1 form-last mtop15">
                                            <asp:DropDownList ID="ddlRelation" runat="server" CssClass="ddlselect">
                                                ...
                                                <asp:ListItem Value="Doughter">Daughter</asp:ListItem>
                                        ...
                                        <div class="col-md-4 form-group1">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server"
                                                ControlToValidate="txtIncome" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>

                                        </div>
                                        <div class="col-md-4 form-group1">
                                            <asp:TextBox ID="txtDesignation" runat="server" placeholder="Designation *" CssClass="textInputStyle"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                                ControlToValidate="txtDesignation" ErrorMessage="*" ForeColor="Red" ValidationGroup="savedata"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
